...
function EXCEPT_FUNCTIONS(name, pattern) {
    USE_STRICT(pattern);
...
const patterns = [
    ...
    {
      code: "each(array, function() { console.log(this) })",
      parserOptions: { ecmaVersion: 6 },
      errors: [{ message: "Unexpected 'this'.", type: "ThisExpression" }],
      valid: [NORMAL, EXCEPT_FUNCTIONS.bind(null, "each")],
      invalid: [USE_STRICT, IMPLIED_STRICT, MODULES]
    }
];
